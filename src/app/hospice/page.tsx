      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative">
            ...
            <div className="w-full flex flex-col items-center text-center lg:pr-6 px-4">
              <div className="inline-block bg-[oklch(0.505_0.213_27.518)] text-white rounded-lg px-4 py-2 mb-4 font-montserrat">
              ...
              <h2 className="text-xl sm:text-2xl font-extrabold mb-3 text-gray-900 font-montserrat">Where We Offer Hospice Services</h2>
              <p className="text-base text-gray-700 font-montserrat mb-4 mx-auto max-w-md">
                We offer life-changing Hospice services throughout Utah County. If we cover your area, reach out to us! Let&apos;s see how we can improve your family member&apos;s quality of life.
              </p>
            </div>
